...
(function () {
    ...
    function renderGrid() {
        ...
        currentDistribution.forEach(function (val) {
    ...
    function startGame() {
        ...
        isPlaying = true;
        currentLevel = parseInt(selectLevel.value, 10);
        timeElapsed = 0;
        ...
        if (btnMusic.innerText.indexOf("ON") !== -1) {
    ...
    function highlightCard(index) {
        ...
        if (cards[index]) {
            ...
            const expectedWord =
                wordType === 0 ? currentPair.w1.word : currentPair.w2.word;
    ...
    function toggleMusic() {
        if (btnMusic.innerText.indexOf("OFF") !== -1) {
